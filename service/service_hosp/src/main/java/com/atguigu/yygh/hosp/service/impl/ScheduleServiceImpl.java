...
//停号时间
    ...
    public Schedule getScheduleId(String scheduleId) {
        return (Schedule) baseMapper.selectById(scheduleId);
    }


    private IPage getListData(int page, int limit, BookingRule bookingRule) {
        //当天放号时间
        ...
        //要对日期进行分页，每个医院的预约周期不一样，一个页面最多显示7天，多了就要分页
